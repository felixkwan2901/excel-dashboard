  ...
  return (
    <form onSubmit={onSubmit} className="relative w-full max-w-md" role="search">
      ...
      <input
        ...
        className="w-full rounded-lg border border-white/[0.08] bg-white/[0.04] py-2 pr-14 pl-9 text-sm text-white placeholder:text-neutral-500 focus:border-emerald-500/50 focus:outline-none"
      />
